...
var require_path_utils = __commonJS({
  "scripts/lib/path-utils.js"(exports2, module2) {
    ...
    function expandHomePath(raw, { homeDir = os2.homedir(), pathApi = path2 } = {}) {
...
var require_redact = __commonJS({
  "scripts/lib/redact.js"(exports2, module2) {
    ...
    function normalizedPath(value, platform) {
      if (platform === "win32") return path2.win32.normalize(withoutExtendedDrivePrefix(value));
      return path2.posix.normalize(value);
    }
...
var require_lock = __commonJS({
  "scripts/lib/lock.js"(exports2, module2) {
    ...
    function inspectLock(lockPath) {
      const metaPath = path2.join(lockPath, "metadata.json");
      try {
    ...
    function removeClaimedDirectory(lockPath, claim) {
      ...
      const retiredClaim = { ...claim, lockPath: retiredPath, metaPath: path2.join(retiredPath, "metadata.json") };
      ...
      try {
        ...
        fs2.unlinkSync(path2.join(retiredPath, "metadata.json"));
...
var require_project_resolver = __commonJS({
  "scripts/lib/project-resolver.js"(exports2, module2) {
    ...
    function resolveProjectScope2(workspaceRoot) {
      ...
      const profilePath = path2.join(projectRoot, ".deep-memory", "project-profile.json");
      let profileText;
      try {
...
// scripts/hooks/user-prompt-submit.mjs
async function main() {
  ...
  try {
    ...
    await normalizeAndAppend("hook-user-prompt", input, detectHost());
  } catch (e) {
    console.error(`[deep-memory] user-prompt-submit hook skipped: ${e && e.message}`);
  }
}
main().finally(() => {
  process.exitCode = 0;
